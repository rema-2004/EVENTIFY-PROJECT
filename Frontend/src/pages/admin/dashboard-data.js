...
(function () {
    ...
    function pendingActions() {
        return [
            ...
            { icon: 'apartment', count: 2, label: 'Organizations pending verification', description: 'New organizations waiting on document review.', href: '/admin/verify-organizations' },
            { icon: 'event_upcoming', count: 4, label: 'Events pending approval', description: 'Submitted events waiting for admin sign-off.', href: '/admin/events' },
            { icon: 'flag', count: 5, label: 'Reports requiring review', description: 'Generated reports flagged for a closer look.', href: '/admin/reports' },
            { icon: 'person_off', count: 3, label: 'Flagged users', description: 'Accounts reported by other users or organizations.', href: '/admin/users' }
        ];
    }
    ...
    function topOrganizations() {
        // Names match those visible on /admin/verify-organizations and /admin/events
        return [
    ...
    function categories() {
        // Must match the categories listed on /admin/categories exactly
        return [
    ...
    function topCompetitions() {
        // Categories aligned with /admin/categories
        return [
